...
<div align=center class="font1">
    ...
    <%
        ...
        if(amtCoffee != null && amtChocolate != null && amtMilk != null && amtSugar != null){
            try {
                cm.addInventory(amtCoffee, amtMilk, amtSugar, amtChocolate);
                out.println("<span class=\"font_failure\">Add Success</span><br>");

            } catch (InventoryException e) {
                // Handle any exceptions thrown by addInventory method
                out.println("<span class=\"font_failure\">" + e.getMessage() + "</span><br>");
            }
        }
    %>
    <br>
